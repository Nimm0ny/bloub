...
export type ViewId = 'animations' | 'personnaliser' | 'lab' | 'reglages'
  ...
  >
    <ul class="flex gap-1 lg:flex-col">
      ...
      >
        ...
        >
          <!--
            Les icones viennent de bibliotheques, pas d'un trace maison :
          ...
          -->
          <!--
            Laboratoire : les curseurs de Solar (`solar:tuning-2-bold`). C'est
            la vue qui ajuste Body / Gaze / Eyes / Expression en direct.
          -->
          <svg
            v-else-if="item.id === 'lab'"
            width="18"
            height="18"
            viewBox="0 0 24 24"
            aria-hidden="true"
